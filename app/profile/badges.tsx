        ...
        <View style={styles.section}>
          ...
          <View style={styles.badgesGrid}>
            {obtainedBadges.map(b => (
              <View key={b.id} style={styles.badgeWrapper}>{renderBadge(b)}</View>
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  badgeCard: { alignItems: "center", padding: 10, borderRadius: 10, backgroundColor: "#f9f9f9" },
  badgeUnobtained: { opacity: 0.6 },
  badgeImage: { width: 80, height: 80, borderRadius: 40, marginBottom: 8 },
  badgeName: { fontSize: 14, fontWeight: "600", textAlign: "center", marginBottom: 4, color: "#000" },
